...
public class MyPostsController extends MainMenuController{
    ...
    public void addPost(int postID, String title, String body, String imageAddress, Timestamp lastEdited){
        ...
        Label newDateLabel = new Label("last edited on " + lastEdited.toString());
